...
class MainWindow(QMainWindow):
    ...
    def edit(self):
        ...
        n_nome = self.tabela.item(lineSel,0)
        n_telefone = self.tabela.item(lineSel,1)
        n_data_recebimento = self.tabela.item(lineSel,2)
        n_descricao = self.tabela.item(lineSel,3)
        n_data_entrega = self.tabela.item(lineSel,4)
        ...
        edit = Consulta(id,n_nome,n_telefone,n_data_recebimento,n_descricao,n_data_entrega)
